...
const mailTemplate = ({ deleteUrl, host, projectName }) =>
  `<!DOCTYPE html>
    <html>
      <head>
                      ...
                      <table style="${styles.tableContent}">
                        <tr>
                          <td>
                            <center><h2 style="${
                              styles.h2
                            }">Delete your account? 😟</h2></center>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding: 8px 0;">
                            <span>We received your request to delete your <a href="${host}" style="${
    styles.a
  }">${projectName}</a> account.</span>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding: 8px 0;">
