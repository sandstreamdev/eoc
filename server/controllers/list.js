  ...
  if (cohortId && isSharedList) {
    Cohort.findOne({ _id: sanitize(cohortId) })
      ...
      .then(() => {
        ...
        return createListCohort(io.getInstance(), dashboardClients)({
          ...listData,
          cohortId
        });
      })
...
const addItemToList = async (req, resp) => {
  ...
  try {
    ...
    socketActions.addItemToList(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const voteForItem = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    socketActions.setVote(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const clearVote = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    socketActions.clearVote(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
  ...
  List.findOneAndUpdate(
    ...
    .then(doc => {
      ...
      return socketActions
        .removeViewer(io.getInstance())(data)
        .then(() => doc);
    })
    .then(payload => {
      resp.send();
  ...
  List.findOne({
    ...
    .then(list => {
      if (user) {
        ...
        return socketActions.addViewer(io.getInstance())({
          listId,
          list: list._doc,
          userToSend
        });
...
const markItemAsDone = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    socketActions.markAsDone(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const markItemAsUnhandled = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    socketActions.markAsUnhandled(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const archiveItem = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    socketActions.archiveItem(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const restoreItem = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    await socketActions.restoreItem(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const updateItem = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    socketActions.updateItem(io.getInstance())({
      itemData: {
        updatedData,
        itemId: sanitizedItemId
      },
...
const cloneItem = async (req, resp) => {
  ...
  try {
    ...
    socketActions.cloneItem(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const deleteItem = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    socketActions.deleteItem(io.getInstance())(data);
  } catch {
    resp.sendStatus(400);
  }
};
...
const leaveList = (req, resp) => {
  ...
  List.findOne({
    ...
    .then(() => {
      ...
      return socketActions.leaveList(io.getInstance())(data);
    })
    .then(() => resp.send())
    .catch(err => {
      if (err instanceof BadRequestException) {
...
const moveItem = async (req, resp) => {
  ...
  try {
    ...
    resp.send();
    await socketActions.moveToList(io.getInstance())({
