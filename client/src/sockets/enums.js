...
export const ListEvents = Object.freeze({
  ...
  LEAVE_ON_TYPE_CHANGE_SUCCESS: ListActionTypes.LEAVE_ON_TYPE_CHANGE_SUCCESS,
  ...
  REMOVED_BY_SOMEONE: ListActionTypes.REMOVED_BY_SOMEONE,
...
export const CohortEvents = Object.freeze({
  ...
  REMOVED_BY_SOMEONE: CohortActionTypes.REMOVED_BY_SOMEONE,
