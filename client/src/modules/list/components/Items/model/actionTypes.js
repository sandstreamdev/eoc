...
export const ItemActionTypes = Object.freeze({
  ...
  FETCH_ARCHIVED_ITEMS_FAILURE: 'item/FETCH_ARCHIVED_ITEMS_FAILURE',
  FETCH_ARCHIVED_ITEMS_SUCCESS: 'item/FETCH_ARCHIVED_ITEMS_SUCCESS',
  REMOVE_ARCHIVED_ITEMS: 'item/REMOVE_ARCHIVED_ITEMS',
