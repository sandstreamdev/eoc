  ...
  var MiSlider = function(stageEl, options) {
    ...
    o.init = function(stageEl, options) {
      ...
      if (
        ...
        parseInt(o.options.increment, 10) !== 0
      ) {
    ...
    o.setup = function() {
      var slidesMaxNum,
        ...
        calcSlideWidth = !(
          ...
          parseInt(o.options.slideWidth, 10) > 0
        ),
        calcStageHeight = !(
          $.isNumeric(o.options.stageHeight) &&
          parseInt(o.options.stageHeight, 10) > 0
        );
      ...
      o.slides.each(function() {
        ...
        if (!o.imagesLoaded) {
          ...
          if (!slide.children().hasClass(o.classSlideContainer)) {
            slide.wrapInner(
              "<div class='" + o.classSlideContainer + "'></div>"
            );
          }
    ...
    o.transition = function(
      ...
      if (!o.animatedElements.is(':animated') && indexTo !== o.indexCurrent) {
        ...
        indexDiff =
          normalizeIndex(indexToAdjusted) -
            ...
            if (o.slideScaling !== 100) {
              ...
              if (o.options.centerV) {
                slideCurrentAdjusted
                  ...
                  .first()
                  .css({
                    marginTop: slideCurrentAdjusted.data(
                      'slideMarginTopCurrent'
                    )
                  });
              }
            }
    ...
    o.addNavList = function() {
      ...
      navList = $(listHtml).on('click', 'li', function(e) {
        e.preventDefault();
